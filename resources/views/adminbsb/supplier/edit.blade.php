...
@section('action')
    <div class="row">
        <div class="col-sm-12">
            <form id="frmSupplier" action="{{ url('/'.BULK_SYSTEM.'/'.$controller.'/'.$supplier->supplier_id) }}" method="POST"  class="form-horizontal" role="form" novalidate="novalidate">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="name" class="form-control limit limit255" value="{{ $supplier->name }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        @include('adminbsb.partials.switch_status', ['module' => 'supplier', 'switchStatus' => $supplier->status])
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                @include('adminbsb.partials.select_province', ['provinceId' => $supplier->province_id])
                            </div>
                            {{-- description --}}
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea name="description" class="form-control limit limit1024 tinyEditor">{{ $supplier->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-5">
                            ...
                            @include('adminbsb.partials.select_picture', ['picture' => $supplier->thumbnail])
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="introduction" class="form-control tinyEditor">{{ $supplier->introduction }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
