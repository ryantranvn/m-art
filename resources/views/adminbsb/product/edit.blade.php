...
@section('action')
    <div class="row">
        <div class="col-sm-12">
            <form id="frmProduct" action="{{ url('/'.BULK_SYSTEM.'/'.$controller.'/'.$product->product_id) }}" method="POST"  class="form-horizontal" role="form" novalidate="novalidate">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        @include('adminbsb.partials.select_supplier', ['supplierId' => $product->supplier_id])
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="province_name" class="form-control" value="{{ $product->province_name }}" readonly/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        @include('adminbsb.partials.select_category', ['categoryId' => $product->category_id])
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="name" class="form-control limit limit255" value="{{ $product->name }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group input-group input-group-sm">
                                <div class="form-line">
                                    <input type="text" name="price" class="form-control align-right font-bold currencyPositive" value="{{ $product->price }}" />
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="small_description" class="form-control limit limit1024" rows="6">{{ $product->small_description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                @include('adminbsb.partials.switch_status', ['module' => 'product', 'switchStatus' => $product->status])
                            </div>
                        </div>
                        <div class="row m-t-20">
                            <div class="col-sm-12">
                                <label class="form-label">{{ trans('adminbsb.product_recommend') }}</label>
                                @include('adminbsb.partials.switch_recommend', ['module' => 'recommend_product', 'switchStatus' => $product->recommend])
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="description" class="form-control tinyEditor" rows="6">{{ $product->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
