            ...
            <div class="wrap_title col col-md-3">
                <div class="media row">
                    <div class="media-left">
                        <img class="media-object normal" src="{{ asset('website/images/phone.png') }}" alt="{{ IMG_ALT }}">
                    </div>
                    ...
                    <div id="slick_hotline" class="slick_container col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object active" src="{{ asset('website/images/skype.png') }}" alt="{{ IMG_ALT }}">
                                    </a>
                                </div>
                                <div class="media-body">
