<div class="form-select">
    <select name="province_id" address-group="<?php if(!empty($groupLocation)): ?> $groupLocation <?php endif; ?>" class="form-control province_id show-tick" data-live-search="true" data-size="5" data-title="<?php echo e(trans('adminbsb.choose_province')); ?>">
