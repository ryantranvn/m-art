<div class="form-select">
    <select name="district_id" address-group="<?php if(!empty($groupLocation)): ?> $groupLocation <?php endif; ?>" class="form-control district_id show-tick" data-live-search="true" data-size="5" data-title="<?php echo e(trans('adminbsb.choose_district')); ?>">
